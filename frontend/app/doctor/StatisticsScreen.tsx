...
const styles = StyleSheet.create({
  ...
  footer: {boxShadow: "0px 0px 10px rgba(0, 0, 0, 0.2)", padding: 16, backgroundColor: Colors.primary,  borderTopColor: Colors.secondary, flexDirection: "column",  alignItems: "stretch",},
